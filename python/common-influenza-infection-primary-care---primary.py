...
codes = [{"code":"1024921000006116","system":"snomedct"},{"code":"1118771000006112","system":"snomedct"},{"code":"843921000033117","system":"snomedct"},{"code":"843921000033117","system":"snomedct"}];
REQUIRED_CODES = 1;
